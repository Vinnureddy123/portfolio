...
export const metadata = {
  ...
  title: {
    default: 'Chennareddy Vinay | Software Engineer',
    template: '%s | Chennareddy Vinay',
  },
  description,
  keywords: [
    'Chennareddy Vinay',
  ...
  authors: [{ name: 'Chennareddy Vinay', url: SITE_URL }],
  creator: 'Chennareddy Vinay',
  openGraph: {
    type: 'website',
    locale: 'en_SG',
    url: SITE_URL,
    siteName: 'Chennareddy Vinay',
    title: 'Chennareddy Vinay | Control-M SME',
    description,
    images: [
      {
        url: '/opengraph-image',
        width: 1200,
        height: 630,
        alt: 'Chennareddy Vinay | Control-M SME Portfolio',
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'Person',
              name: 'Chennareddy Vinay',
              url: SITE_URL,
              email: 'chennareddyvinay@gmail.com',
